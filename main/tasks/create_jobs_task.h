...
// Re-distribute current mining job to all active cluster slaves immediately.
// Call this when a new slave registers so it doesn't wait for the next mining.notify.
