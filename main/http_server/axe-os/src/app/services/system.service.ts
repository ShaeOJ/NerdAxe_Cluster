...
export class SystemService {
  ...
  public updateSwarm(uri: string = '', swarmConfig: any) {
    return this.httpClient.patch(`${uri}/api/swarm`, swarmConfig, { responseType: 'text' });
  }

  public updateSlave(slaveId: number, config: any) {
    return this.httpClient.patch(`/api/swarm/slaves/${slaveId}`, config, { responseType: 'text' });
  }

  public restartSlave(slaveId: number) {
    return this.httpClient.post(`/api/swarm/slaves/${slaveId}/restart`, null, { responseType: 'text' });
  }

  public getWatchdogStatus() {
    return this.httpClient.get('/api/swarm/watchdog');
  }

  public setWatchdogEnabled(enabled: boolean) {
    return this.httpClient.post('/api/swarm/watchdog', { enabled }, { responseType: 'text' });
  }
