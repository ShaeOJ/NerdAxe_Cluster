...
export class HeaderComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    // Track accent color changes for the indicator dot
    this.themeSettingsService.themeSettings$
      .pipe(takeUntil(this.destroy$))
      .subscribe(s => this.accentColor = s.accentColor);
  ...
  changeTheme(themeName: string) {
    ...
    // Sync color scheme to the design/theme settings service
    this.themeSettingsService.updateColorScheme(themeName);
