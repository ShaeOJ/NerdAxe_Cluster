...
// Cluster mode
#define NVS_CONFIG_CLUSTER_MODE    "clustermode"    // 0=disabled, 1=master, 2=slave
#define NVS_CONFIG_CLUSTER_CHANNEL "clusterchan"    // ESP-NOW WiFi channel (1-14)
...
namespace Config {
    ...
    inline uint16_t getClusterMode() { return nvs_config_get_u16(NVS_CONFIG_CLUSTER_MODE, CONFIG_CLUSTER_MODE_VALUE); }
    inline uint16_t getClusterChannel() { return nvs_config_get_u16(NVS_CONFIG_CLUSTER_CHANNEL, CONFIG_CLUSTER_CHANNEL); }
    ...
    inline void setClusterMode(uint16_t value) { nvs_config_set_u16(NVS_CONFIG_CLUSTER_MODE, value); }
    inline void setClusterChannel(uint16_t value) { nvs_config_set_u16(NVS_CONFIG_CLUSTER_CHANNEL, value); }
