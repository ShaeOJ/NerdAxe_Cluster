...
class History {
  protected:
    ...
    float *m_clusterHashrate = nullptr;
  ...
  public:
    ...
    void push(float rateGh, float vregTemp, float asicTemp, uint64_t timestamp, float clusterHashrate = 0.0f);
    ...
    float getClusterHashrateSample(int index);
